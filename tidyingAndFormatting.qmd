...
d01 <- read_csv(
  "data/responses_776cc413-2716-4170-987c-6f9b4658a726_RUNNING_2023-10-10101.csv",
  col_types =
    cols(
...
saveRDS(
  tidiedData,
  "data/tidyLabeledSurveyData.rds"
  )
...
saveRDS(longerDataSimple, "data/longerDataSimple.rds")
...
#saveRDS(wideDataSimple, "data/wideDataSimple.rds")
...
saveRDS(longerDataContributions, "data/longerDataContributions.rds")
...
saveRDS(longerDataDeterrents, "data/longerDataDeterrents.rds")
...
#      Rmd.file = "bibs/grateful-report-tidying.Rmd",
