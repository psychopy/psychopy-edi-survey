...
```{r longerDataSimple_ToRDS}

saveRDS(longerDataSimple, "longerDataSimple.rds")
...
longerDataContributions <-
  ...
  mutate(., selected = fct_recode(selected, "selected" = "1", "not selected" = "0"))
...
```{r savelongerDataContributionsToRDS}

saveRDS(longerDataContributions, "longerDataContributions.rds")
...
```{r savelongerDataDeterrentsToRDS}

saveRDS(longerDataDeterrents, "longerDataDeterrents.rds")
