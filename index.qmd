...
suppressWarnings(cowplot::plot_grid(GnWh, GnFa, nrow = 2))
...
gdata::mv("p", "PsEt") # p is sent to the global env. from the function
suppressWarnings(print(PsEt))
...
gdata::mv("p", "AwCc") # p is sent to the global env. from the function
suppressWarnings(print(AwCc))
