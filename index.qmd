...
>`r sjlabelled::get_label(visMain$gender)`
...
>`r sjlabelled::get_label(visMain$genderDesc)`
...
>`r sjlabelled::get_label(visMain$genderAffected)`
...
The following statements were seen only by the subset of participants noted above. Specifically, they were restricted to the **`r numbers_to_words(length(which(visMain$genderAffected=="Yes")))`** who replied ***yes*** to the question asking them whether they had felt that their gender identity has affected their interactions with the *PsychoPy*<sup>&reg;</sup> community. Of those, **`r numbers_to_words(length(which(!is.na(visMain$genderNegPerc))))`** provided responses, seen below.
...
>`r sjlabelled::get_label(visMain$nonHeteroDesc)`
...
>`r sjlabelled::get_label(visMain$nonHeteroAffected)`
...
The following statements were seen only by the subset of participants noted above. Specifically, they were restricted to the **`r numbers_to_words(length(which(visMain$nonHeteroAffected=="Yes")))`** who replied ***yes*** to the question asking them whether they had felt that their sexual orientation has affected their interactions with the *PsychoPy*<sup>&reg;</sup> community. Of those, **`r numbers_to_words(length(which(!is.na(visMain$nonHeteroNegPerc))))`** provided responses, seen below.
...
>`r sjlabelled::get_label(visMain$raceCultureDesc)`
...
>`r sjlabelled::get_label(visMain$raceCultureAffected)`
...
>`r sjlabelled::get_label(visMain$disabilityDesc)`
...
>`r sjlabelled::get_label(visMain$disabilityAffected)`
...
The following statements were seen only by the subset of participants noted above. Specifically, they were restricted to the **`r numbers_to_words(length(which(visMain$disabilityAffected=="Yes")))`** who replied ***yes*** to the question asking them whether they had felt that their disability and/or neurodivergence has affected their interactions with the *PsychoPy*<sup>&reg;</sup> community. Of those, **`r numbers_to_words(length(which(!is.na(visMain$disabilityNegPerc))))`** provided responses, seen below.
...
>`r sjlabelled::get_label(visMain$domLangDesc)`
...
>`r sjlabelled::get_label(visMain$domLangAffected)`
...
The following statements were seen only by the subset of participants noted above. Specifically, they were restricted to the **`r numbers_to_words(length(which(visMain$domLangAffected=="Yes")))`** who replied ***yes*** to the question asking them whether they had felt that their language dominance has affected their interactions with the *PsychoPy*<sup>&reg;</sup> community. Of those, **`r numbers_to_words(length(which(!is.na(visMain$domLangNegPerc))))`** provided responses, seen below.
...
>`r sjlabelled::get_label(visMain$careerStatus)`
...
careerStatusLabel <- sjlabelled::get_label(longerDataSimple$careerStatus)
...
>`r sjlabelled::get_label(visMain$engagement)`
...
engagementLabel <- sjlabelled::get_label(longerDataSimple$careerStatus)
...
longerDataContributions <- readRDS("data/longerDataContributions.rds")
contributeLabel <- sjlabelled::get_label(longerDataContributions$contributionType)
...
#| tbl-cap: "Summary of responses by disability and/or neurodivergence to ways of contributing"
#| output: asis
...
deterrentsLabel <- sjlabelled::get_label(longerDataDeterrents$deterrent)
...
textForSpan <- sjlabelled::get_label(visMain$gender)
...
textForSpan <- sjlabelled::get_label(visMain$nonHeteroCommunity)
...
textForSpan <- sjlabelled::get_label(visMain$raceCulture)
visMain |>
...
textForSpan <- sjlabelled::get_label(visMain$disability)
...
textForSpan <- sjlabelled::get_label(visMain$domLangEnglish)
...
>`r sjlabelled::get_label(visMain$workshopsOnContributing)`
...
workshopLabel <- sjlabelled::get_label(longerDataSimple$workshopsOnContributing)
likertValues <- sjlabelled::get_labels(longerDataSimple$workshopsOnContributing)
...
>`r sjlabelled::get_label(visMain$awareOfCodeOfConduct)`
...
codeOfConductLabel <- sjlabelled::get_label(longerDataSimple$awareOfCodeOfConduct)
...
>`r sjlabelled::get_label(visMain$psychopyDocumentationEasy)`
...
docEasyLabel <- sjlabelled::get_label(visMain$psychopyDocumentationEasy)
...
#| fig-alt: "Boxplots of responses by EDI variables by gender to the question regarding whether the participants felt the documentation for PsychoPy was easily findable, searchable, and accessible." 
...
>`r sjlabelled::get_label(visMain$trustCodeWillBeEnforced)`
...
trustCodeLabel <- sjlabelled::get_label(visMain$trustCodeWillBeEnforced)
