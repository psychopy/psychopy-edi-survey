...
Each of the headings in the list above above is depicted below with a visualisation, followed by a table of the data, and in the cases of identity, a table of descriptions supplied by the participants.

# summaries

## user background and experience (EDI)
...
## user background and experience (non-EDI)
...
```{r likertTableWorkshopsOnContributing}
